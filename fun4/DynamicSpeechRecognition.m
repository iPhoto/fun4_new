//
//  DynamicSpeechRecogonition.m
//  fun4
//
//  Created by Ni Yan on 4/30/14.
...
- (void) audioSessionInterruptionDidEnd {
    ...
    [self.pocketController startListeningWithLanguageModelAtPath:self.pathToDynamicallyGeneratedGrammar dictionaryAtPath:self.pathToDynamicallyGeneratedDictionary acousticModelAtPath:[AcousticModel pathToModel:@"AcousticModelEnglish"] languageModelIsJSGF:NO];
}
